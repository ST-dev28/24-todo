class Todo {
    constructor(IDselector) {
        ...
        // is localStorage bandom visas parasytas zinutes
    ...
    init() {
        ...
        this.DOM = document.getElementById(this.IDselector);  //geresnis variantas, kai ieskom pagal ID
        //ieskom, ar randa sia vieta
        if (!this.DOM) {
            console.error('ERROR: nerasta vieta, pagal duota selector');
            return false;
        }
        //sukutiam sarasui klase
        this.DOM.classList.add('todo');

        //issipiesiam pradini turini
        //console.log('piesiam...');
        this.render();
        this.renderList();
        this.addEvents();
    ...
    addEvents() {
        ...
        this.buttonSaveDOM.addEventListener('click', (e) => {
            ...
            // atnaujina info, kuri yra atminty
            //localStorage.setItem(this.localStorageTodoKey, JSON.stringify(this.messages));
